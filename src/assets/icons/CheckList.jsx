...
export default function CheckList({ fill, ...props }) {
  return (
    <svg
    ...
    >
      ...
      <path d="M28.8 46.4c0 .8.7 1.5 1.5 1.5h38.5c.8 0 1.5-.7 1.5-1.5s-.7-1.5-1.5-1.5H30.3c-.8 0-1.5.7-1.5 1.5zM68.8 55.4H30.3c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5h38.5c.8 0 1.5-.7 1.5-1.5s-.7-1.5-1.5-1.5zM68.8 66.4H30.3c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5h38.5c.8 0 1.5-.7 1.5-1.5s-.7-1.5-1.5-1.5z" />
    </svg>
  );
}
